...
// P3tr0viCh        mSelectedMonthTextView.setText(mCalendar.getDisplayName(Calendar.MONTH, Calendar.SHORT,
//                Locale.getDefault()).toUpperCase(Locale.getDefault()));
// P3tr0viCh add ----
        mSelectedMonthTextView.setText(DateUtils.formatDateTime(getActivity(), mCalendar.getTimeInMillis(),
                DateUtils.FORMAT_SHOW_DATE | DateUtils.FORMAT_NO_YEAR | DateUtils.FORMAT_NO_MONTH_DAY).toUpperCase(Locale.getDefault()));
// P3tr0viCh add ----
